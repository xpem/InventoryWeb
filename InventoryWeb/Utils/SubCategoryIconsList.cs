...
namespace InventoryWeb.Utils
{
    ...
    {
        public static string GetIconName(string faName) => Icons.Where((s) => s.faName == faName).First().name;

        public static string GetIconFaName(string name) => Icons.Where((s) => s.name == name).FirstOrDefault().faName;

        /// <summary>
        ///to index icons for his name
        /// </summary>
        public static readonly IEnumerable<(string faName, string name)> Icons = new List<(string, string)>()
        {
            new ("couch", "Couch"),
            new ("computer", "Computer"),
            new ("kitchen-set", "kitchenSet"),
            new ("tv", "Tv"),
            new ("tag", "Tag"),
            new ("mobile", "Mobile"),
            new ("book", "Book"),
            ...
            new ("wrench", "Wrench"),
            new ("screwdriver", "Screwdriver"),
            new ("box", "Box"),
            new ("tshirt", "Tshirt"),
            new ("plug", "Plug"),
            new ("cube", "Cube"),
            new ("shoe-prints", "ShoePrints"),
        };
    }
}
